...
particle = 'muonNeutrino' #'muonNeutrino' #'3_neutrinos' #'muon'
save_filename = 'muonNeutrino_set2' #'muon_set2' #'muonNeutrino_set1' #'neutrinos_set1' #'muon_set1'
...
#         pos = torch.tensor(events[['dom_x','dom_y','dom_z']].values,dtype=torch.float) #Position
    ...
    query = "SELECT energy_log10, time, position_x, position_y, position_z, direction_x, direction_y, direction_z, azimuth, zenith FROM truth WHERE event_no IN {}".format(tuple(event_no_subset.event_no))
